 ...
 */
@Controller
@RequestMapping ("/insertTrainLog")
public class QryFileIdController {
	@Resource
	FormService formService;
	FormMapper formMapper = SpringUtils.getBean("simpleDao");
	
	@RequestMapping(value = "")
	public void my(String name,Model model,HttpServletRequest request,FormEngineRequest requestObj,QueryPage qp) {
